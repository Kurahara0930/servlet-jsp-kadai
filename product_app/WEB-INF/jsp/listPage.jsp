...
<body>
    ...
    <main>
    	...
    	<article class="products">
    		...
    		if(failureMessage == null || failureMessage.isEmpty()) {
	    		if(iCurrentPage > 1) {
	    			out.println("<a class='pagination-link-first' href='" + request.getContextPath() + "/list?page=1&order=" + order + "&keyword=" + keyword + "'>&lt;最初へ</a>");
	    			out.println("<a class='pagination-link' href='" + request.getContextPath() + "/list?page=" + (iCurrentPage - 1) + "&order=" + order + "&keyword=" + keyword + "'>前へ</a>");
	    		}
	    			out.println("<span class='pagination-text'>ページ " + iCurrentPage + "/" + iTotalPages + "</span>");
	       		if(iCurrentPage < iTotalPages) {
	       			out.println("<a class='pagination-link' href='" + request.getContextPath() + "/list?page=" + (iCurrentPage + 1) + "&order=" + order + "&keyword=" + keyword + "'>次へ</a>");
	       			out.println("<a class='pagination-link-last' href='" + request.getContextPath() + "/list?page=" + iTotalPages + "&order=" + order + "&keyword=" + keyword + "'>最後へ&gt;</a>");
	       		}
    		}
    		%>
    		</div>
